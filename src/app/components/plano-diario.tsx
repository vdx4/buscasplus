...
export function PlanoDiario() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: inView ? 1 : 0, y: inView ? 0 : 50 }} // Animação de entrada
      exit={{ opacity: 0, y: -50 }}
    ...
    >
      <motion.div
        ...
        animate={{ scale: inView ? 1 : 0.9, opacity: inView ? 1 : 0 }} // Animar o tamanho e a opacidade
      ...
      >
        ...
        <Link
          href={`/whatsapp?${encodeURIComponent(`plano=Plano Básico&duracao=24 horas&preco=50`)}`}
        >
          <Button
            ...
            onClick={() =>
              gtag_report_conversion(
                `/whatsapp?${encodeURIComponent(`plano=Plano Básico&duracao=24 horas&preco=50`)}`,
              )
            }
          >
            Alugar Agora
